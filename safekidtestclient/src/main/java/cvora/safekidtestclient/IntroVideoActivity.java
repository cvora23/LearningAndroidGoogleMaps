...
public class IntroVideoActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        youTubePlayerView.initialize(QuickstartPreferences.DEVELOPER_KEY,this);
    }

    public void onBtnSkipIntro(View view){
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
        sharedPreferences.edit().putBoolean(getResources().getString(R.string.Skip_Intro),true).apply();
        finish();
    }
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean wasRestored) {
        ...
        if(!wasRestored){
            youTubePlayer.cueVideo(QuickstartPreferences.YOUTUBE_VIDEO_CODE);
        }
    }
